...
var regexBodyMatch = require('../lib/regex-body-match');
var expect = require('chai').expect;

describe.skip('Given a matching valid body, valid path and valid configuration', function(){
    ...
    matchingConfigurations.forEach(function(config, index){
        it('should match each pattern - test ' + index, function(){
            expect(regexBodyMatch(config.path, config.rule, config.body, config.expected)).to.be.true;
        });
    });
});

describe.skip('Given a non-matching body, valid path and valid configuration', function(){
